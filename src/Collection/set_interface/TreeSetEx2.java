...
public class TreeSetEx2 {
    public static void main(String[] args) {
        ...
        Student st4 = new Student("Maria", 3);
        ...
        System.out.println(treeSet.headSet(st6)); // берем объекты из головы
        System.out.println(treeSet.tailSet(st6)); // берем объекты из хвоста включительно
